...
Run 2026-09-13T05:00:08.312Z. Addresses truncated for this file.
...
**90 borrowers profiled. 17 of them are levered across more than one protocol, carrying $1,200,628,840 of debt. 29 become distressed within the policy's shock ladder.**
...
|---|---|---|---|---|---|---|---|
| 1 | `0xf0bb2086…73416c` | 1 (aave-v3-eth) | $1,031,753,752 | $1,120,691,981 | 0.87x | `0xbdfa7b78…275129` | −5% |
| 2 | `0x9600a48e…b22745` | 3 (aave-v3-eth, compound-v3-eth, morpho-aave-v2-eth) | $753,470,035 | $820,581,546 | 0.87x | `0xcd5fe23c…59b7ee` | −5% |
| 3 | `0xf34d97c6…5ca6da` | 1 (aave-v3-eth) | $310,634,651 | $340,108,020 | 1.04x | `0xcd5fe23c…59b7ee` | −5% |
| 4 | `0xcdfa7efe…f49c89` | 1 (aave-v3-eth) | $279,801,064 | $298,624,610 | 0.80x | `0xa1290d69…99e5a7` | −5% |
| 5 | `0x893aa69f…290080` | 1 (aave-v3-eth) | $249,061,662 | $294,353,956 | 0.96x | `0x7f39c581…5e2ca0` | −5% |
| 6 | `0xc468315a…f74ca6` | 1 (aave-v3-eth) | $194,726,995 | $218,101,221 | 1.06x | `0x4c9edd58…1e68b3` | −10% |
| 7 | `0x7cd0b7ed…70c912` | 1 (aave-v3-eth) | $194,545,252 | $416,477,214 | 1.67x | `0xcbb7c000…ed33bf` | — |
| 8 | `0xd9381427…b048dd` | 1 (aave-v3-eth) | $193,548,968 | $211,458,287 | 1.04x | `0x4c9edd58…1e68b3` | −5% |
| 9 | `0xabdbbd00…eef8d6` | 1 (aave-v3-eth) | $176,920,206 | $556,584,267 | 2.45x | `0xcbb7c000…ed33bf` | — |
| 10 | `0x4f87de7d…790545` | 1 (aave-v3-eth) | $175,977,917 | $196,964,208 | 1.06x | `0xcd5fe23c…59b7ee` | −10% |
| 11 | `0xc70ad21c…013810` | 1 (aave-v3-eth) | $141,983,176 | $318,120,728 | 1.86x | `0xc02aaa39…756cc2` | — |
| 12 | `0x741aa7cf…4131f3` | 2 (aave-v3-eth, morpho-aave-v2-eth) | $132,267,260 | $348,437,643 | 2.19x | `0xc02aaa39…756cc2` | — |
| 13 | `0xf7462251…c83010` | 2 (aave-v3-eth, compound-v3-eth) | $131,848,356 | $138,815,931 | 0.79x | `0xa1290d69…99e5a7` | −5% |
| 14 | `0x40e93a52…f7aba8` | 1 (aave-v3-eth) | $130,043,586 | $140,858,074 | 0.81x | `0xa1290d69…99e5a7` | −5% |
| 15 | `0x7ee29373…df5178` | 1 (aave-v3-eth) | $112,612,600 | $508,821,216 | 3.64x | `0x7f39c581…5e2ca0` | — |
| 16 | `0x99926ab8…70f242` | 1 (aave-v3-eth) | $112,555,003 | $244,369,196 | 1.79x | `0xc02aaa39…756cc2` | — |
| 17 | `0x28a55c4b…38a6b0` | 1 (aave-v3-eth) | $108,220,024 | $289,415,337 | 2.22x | `0xc02aaa39…756cc2` | — |
| 18 | `0xe40d278a…ef03bf` | 1 (aave-v3-eth) | $95,757,432 | $195,323,866 | 1.64x | `0xcbb7c000…ed33bf` | — |
| 19 | `0x32073633…8b7910` | 1 (aave-v3-eth) | $91,073,739 | $101,451,938 | 1.06x | `0x356b8d89…d5ba7d` | −10% |
| 20 | `0xd848f542…7af452` | 1 (aave-v3-eth) | $88,279,569 | $262,233,643 | 2.41x | `0x7f39c581…5e2ca0` | — |
| 21 | `0x755013a7…654e60` | 1 (aave-v3-eth) | $78,253,537 | $85,026,472 | 0.81x | `0xa1290d69…99e5a7` | −5% |
| 22 | `0x973ddb8e…951683` | 1 (aave-v3-eth) | $74,833,742 | $77,319,493 | 0.77x | `0xa1290d69…99e5a7` | −5% |
...
| 25 | `0x34780c20…69ddcf` | 1 (aave-v3-eth) | $69,389,202 | $239,808,307 | 2.87x | `0xc02aaa39…756cc2` | — |
